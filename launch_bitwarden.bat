...
Color 0A
cls
title Portable Bitwarden Launcher - Helper Edition
...
:2
:LaunchBitwarden
if not exist ".\bin\bitwarden\!arch!Bit\Bitwarden.exe" set "nag=PLEASE INSTALL BITWARDEN FIRST" & (goto) 2>nul
title DO NOT CLOSE
cls
...
if exist .\data\AppData\Roaming\Bitwarden\ rmdir /s /q .\data\AppData\Roaming\Bitwarden\
(goto) 2>nul
