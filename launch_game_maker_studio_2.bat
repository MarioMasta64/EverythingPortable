...
Color 0A
cls
title Portable Game Maker Studio 2 Launcher - Helper Edition
...
if not exist ".\bin\game_maker_studio_2\GameMakerStudio.exe" set "nag=PLEASE INSTALL GAME MAKER STUDIO 2 FIRST" & (goto) 2>nul
title DO NOT CLOSE
cls
