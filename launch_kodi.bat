...
rmdir /s /q .\bin\kodi\portable_data\
(goto) 2>nul

:4
:UninstallKodi
taskkill /f /im Kodi.exe
for /d %%i in (".\bin\kodi\*") do if /i not "%%i"==".\bin\kodi\portable_data" rmdir /s /q "%%i"
echo y | del .\bin\kodi\*.*
del .\extra\*kodi*
(goto) 2>nul
...
echo set "folder=%%CD%%" >> quicklaunch_kodi.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_kodi.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_kodi.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_kodi.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_kodi.bat
echo set "path=%%path%%;%%folder%%\dll\32\;" >> quicklaunch_kodi.bat
echo cls >> quicklaunch_kodi.bat
...
pause
if exist "!kodi_exe!" del "!kodi_exe!"
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_kodi.bat" "launch_kodi.bat.1"
cls & if exist launch_kodi.bat.1 goto ReplacerCreate
