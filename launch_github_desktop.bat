...
Color 0A
cls
title Portable Github Desktop Launcher - Helper Edition
...
:2
:LaunchGithubDesktop
if not exist ".\bin\github_desktop\GitHubDesktop" set "nag=PLEASE INSTALL GITHUB DESKTOP FIRST" && (goto) 2>nul
title DO NOT CLOSE
cls
echo GITHUB DESKTOP IS RUNNING
set "Path=!path!;!folder!\bin\github_desktop\resources\app\git\cmd\"
start .\bin\github_desktop\GitHubDesktop
exit
...
del .\extra\GitHubDesktopSetup.exe
(goto) 2>nul
...
echo cls >> quicklaunch_github_desktop.bat
echo set "folder=%%CD%%" >> quicklaunch_github_desktop.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_github_desktop.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_github_desktop.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_github_desktop.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_github_desktop.bat
echo set "Path=%%path%%;%%folder%%\bin\github_desktop\resources\app\git\cmd\" >> quicklaunch_github_desktop.bat
echo cls >> quicklaunch_github_desktop.bat
echo start .\bin\github_desktop\GitHubDesktop.exe >> quicklaunch_github_desktop.bat
echo exit >> quicklaunch_github_desktop.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_github_desktop.bat
...
if not exist ".\bin\github_desktop\GitHubDesktop" set nag=GITHUB DESKTOP IS NOT INSTALLED CHOOSE "D"
(goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_github_desktop.bat" "launch_github_desktop.bat.1"
cls & if exist launch_github_desktop.bat.1 goto ReplacerCreate
