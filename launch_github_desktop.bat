...
Color 0A
cls
title Portable Github Desktop Launcher - Experimental Edition
...
call :Credits
call :Check-Scripts
call :Github-Desktop-Check

:Menu
cls
title Portable Github Desktop Launcher - Experimental Edition - Main Menu
echo %NAG%
set nag="Selection Time!"
echo 1. reinstall github desktop [will remove github desktop entirely]
echo 2. launch github desktop [launches githubdesktop]
echo 3. reset github desktop [will remove everything github desktop except the binary]
echo 4. uninstall github desktop [y tho?]
...
cls
title Portable Github Desktop Launcher - Experimental Edition - Checking For Update
...
:About
cls
del .\doc\github_desktop_license.txt
start launch_github_desktop.bat
exit
...
cls & title Portable Github Desktop Launcher - Experimental Edition - Download Dll Downloader
...
:b
:Portable-Everything
cls & title Portable Github Desktop Launcher - Experimental Edition - Download Suite
cls & if not exist .\bin\wget.exe call :Download-Wget
...
:Folder-Check
cls
if not exist .\bin\github_desktop\ mkdir .\bin\github_desktop\
...
:Credits
cls
if exist .\doc\github_desktop_license.txt (goto) 2>nul
echo ================================================== > .\doc\github_desktop_license.txt
echo =              Script by MarioMasta64            = >> .\doc\github_desktop_license.txt
echo =           Script Version: v%current_version%- release        = >> .\doc\github_desktop_license.txt
echo ================================================== >> .\doc\github_desktop_license.txt
echo =You may Modify this WITH consent of the original= >> .\doc\github_desktop_license.txt
echo = creator, as long as you include a copy of this = >> .\doc\github_desktop_license.txt
echo =      as you include a copy of the License      = >> .\doc\github_desktop_license.txt
echo ================================================== >> .\doc\github_desktop_license.txt
echo =    You may also modify this script without     = >> .\doc\github_desktop_license.txt
echo =         consent for PERSONAL USE ONLY          = >> .\doc\github_desktop_license.txt
echo ================================================== >> .\doc\github_desktop_license.txt
cls
title Portable Github Desktop Launcher - Experimental Edition - About
for /f "DELIMS=" %%i in (.\doc\github_desktop_license.txt) do (echo %%i)
pause
(goto) 2>nul
...
:Download-Wget
cls
title Portable Github Desktop Launcher - Experimental Edition - Download Wget
...
:Download-7zip
cls
title Portable Github Desktop Launcher - Experimental Edition - Download 7zip
if not exist .\bin\wget.exe call :Download-Wget
...
cls
if not exist .\bin\github_desktop\GitHubDesktop.exe call :File-Check & goto Github-Desktop-Check
(goto) 2>nul

:File-Check
if not exist .\extra\githubdesktop.exe call :Download-Github-Desktop
if exist .\extra\githubdesktop.exe call :Extract-Github-Desktop
(goto) 2>nul

:Download-Github-Desktop
if exist "win32" rename "win32" githubdesktop.exe
if exist githubdesktop.exe call :Move-Github-Desktop & (goto) 2>nul
if not exist .\bin\wget.exe call :Download-Wget
cls
title Portable Github Desktop Launcher - Experimental Edition - Download Github Desktop
.\bin\wget.exe -q --show-progress "https://central.github.com/deployments/desktop/desktop/latest/win32"

:Move-Github-Desktop
cls
if not exist githubdesktop.exe (goto) 2>nul
move githubdesktop.exe .\extra\githubdesktop.exe
(goto) 2>nul

########################################################################

:Extract-Github-Desktop
cls
title Portable Github Desktop Launcher - Experimental Edition - Extract Github Desktop
if not exist .\temp\GitHubDesktop*.nupkg call :Extract-Github-Desktop-Binary
if exist .\temp\GitHubDesktop*.nupkg call :Extract-Github-Desktop-Nupkg
(goto) 2>nul

########################################################################

:Extract-Github-Desktop-Binary
cls
title Portable Github Desktop Launcher - Experimental Edition - Extract Github Desktop
if not exist .\bin\7-ZipPortable\App\7-Zip\7z.exe call :Download-7zip
.\bin\7-ZipPortable\App\7-Zip\7z.exe x .\extra\githubdesktop.exe * -o.\temp\
del .\temp\RELEASES
del .\temp\Update.exe
del .\extra\githubdesktop.exe
(goto) 2>nul

########################################################################

:Extract-Github-Desktop-Nupkg
cls
title Portable Github Desktop Launcher - Experimental Edition - Extract Github Desktop Nupkg
for %%d in (.\temp\GitHubDesktop*.nupkg) do set githubdesktop=%%d
if not exist .\bin\7-ZipPortable\App\7-Zip\7z.exe call :Download-7zip
.\bin\7-ZipPortable\App\7-Zip\7z.exe x %githubdesktop% * -o.\temp\
del %githubdesktop%
...
:Update-Wget
cls
title Portable Github Desktop Launcher - Experimental Edition - Update Wget
...
:Latest-Build
cls
title Portable Github Desktop Launcher - Experimental Edition - Latest Build :D
...
:New-Update
cls
title Portable Github Desktop Launcher - Experimental Edition - Old Build D:
echo %NAG%
set nag="Selection Time!"
...
:Update-Now
cls & if not exist .\bin\wget.exe call :Download-Wget
cls & title Portable Github Desktop Launcher - Experimental Edition - Updating Launcher
cls & .\bin\wget.exe -q --show-progress https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_github_desktop.bat
cls & if exist launch_github_desktop.bat.1 goto Replacer-Create
...
echo del launch_github_desktop.bat >> replacer.bat
echo rename launch_github_desktop.bat.1 launch_github_desktop.bat >> replacer.bat
echo start launch_github_desktop.bat >> replacer.bat
...
:Preview-Build
cls
title Portable Github Desktop Launcher - Experimental Edition - Test Build :0
...
:cmd
cls
title Portable Github Desktop Launcher - Experimental Edition - Command Prompt - By MarioMasta64
ver
