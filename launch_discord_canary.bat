...
rmdir /s /q .\bin\DiscordCanary\tdata\
(goto) 2>nul
...
echo cls >> quicklaunch_discord_canary.bat
echo set "folder=%%CD%%" >> quicklaunch_discord_canary.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_discord_canary.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_discord_canary.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_discord_canary.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_discord_canary.bat
echo cls >> quicklaunch_discord_canary.bat
echo start .\bin\discord_canary\discord.exe >> quicklaunch_discord_canary.bat
echo exit >> quicklaunch_discord_canary.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_discord_canary.bat
echo ENTER TO CONTINUE & pause>nul:
(goto) 2>nul

:d
:UpgradeDiscordCanary
if exist "download?platform=win" del "download?platform=win"
...
:Credits
cls
if exist .\doc\discord_license.txt (goto) 2>nul
echo ================================================== > .\doc\discord_license.txt
echo =              Script by MarioMasta64            = >> .\doc\discord_license.txt
echo =           Script Version: v%current_version%- release        = >> .\doc\discord_license.txt
echo ================================================== >> .\doc\discord_license.txt
