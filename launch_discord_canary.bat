...
if exist .\data\AppData\Roaming\discord\ rmdir /s /q .\data\AppData\Roaming\discord\
if exist .\data\AppData\Roaming\discordcanary\ rmdir /s /q .\data\AppData\Roaming\discordcanary\
(goto) 2>nul
