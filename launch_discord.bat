...
Color 0A
cls
title Portable Discord Launcher - Experimental Edition
...
:Menu
cls
title Portable Discord Launcher - Experimental Edition - Main Menu
echo %NAG%
set nag="Selection Time!"
echo 1. reinstall discord [will remove discord entirely]
echo 2. launch discord [launches discord canary]
...
:8
:Write-Discord-Change-Log
cls
title Portable Discord Launcher - Expiremental Edition - Change Log
...
echo. >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
echo =                            Discord Launcher - v3                    = >> .\doc\discord_canary_changelog.txt 
echo =                          Experimental Code Edition                      = >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
echo = (ﾉ◕ヮ◕)ﾉ Further improvements to overall system stability and other      = >> .\doc\discord_canary_changelog.txt 
echo = (ﾉ◕ヮ◕)ﾉ minor adjustments have been made to enhance the user experience = >> .\doc\discord_canary_changelog.txt 
...
echo. >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
echo =                            Discord Launcher - v4                    = >> .\doc\discord_canary_changelog.txt 
echo =                          Experimental Code Edition                      = >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
echo = (ﾉ◕ヮ◕)ﾉ Further improvements to overall system stability and other      = >> .\doc\discord_canary_changelog.txt 
echo = (ﾉ◕ヮ◕)ﾉ minor adjustments have been made to enhance the user experience = >> .\doc\discord_canary_changelog.txt 
...
echo. >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
echo =                            Discord Launcher - v5                    = >> .\doc\discord_canary_changelog.txt 
echo =                          Experimental Code Edition                      = >> .\doc\discord_canary_changelog.txt 
echo =========================================================================== >> .\doc\discord_canary_changelog.txt 
...
cls & title Portable Discord Launcher - Experimental Edition - Download Dll Downloader
...
:b
:Portable-Everything
cls & title Portable Discord Launcher - Experimental Edition - Download Suite
cls & if not exist .\bin\wget.exe call :Download-Wget
...
:Credits
cls
if not exist .\doc\discord_canary_changelog.txt call :Write-Discord-Change-Log
...
echo ================================================== >> .\doc\discord_canary_license.txt
cls
title Portable Discord Launcher - Experimental Edition - About
...
:Download-Wget
cls
title Portable Discord Launcher - Experimental Edition - Download Wget
...
:Download-7zip
cls
title Portable Discord Launcher - Experimental Edition - Download 7zip
if not exist .\bin\wget.exe call :Download-Wget
...
:Discord-Check
cls
if not exist .\bin\discord\Discord.exe call :File-Check & goto Discord-Check
(goto) 2>nul

:File-Check
if not exist .\extra\discord.exe call :Download-Discord
if exist .\extra\discord.exe call :Extract-Discord
(goto) 2>nul

:Download-Discord
if exist "download?platform=win" rename "download?platform=win" discord.exe
if exist discord.exe call :Move-Discord & (goto) 2>nul
if not exist .\bin\wget.exe call :Download-Wget
cls
...
:Move-Discord
cls
if not exist discord.exe (goto) 2>nul
...
:Extract-Discord
cls
title Portable Discord Launcher - Experimental Edition - Extract Discord
if not exist .\temp\Discord*.nupkg call :Extract-Discord-Binary
if exist .\temp\Discord*.nupkg call :Extract-Discord-Nupkg
(goto) 2>nul

########################################################################

:Extract-Discord-Binary
cls
title Portable Discord Launcher - Experimental Edition - Extract Discord
if not exist .\bin\7-ZipPortable\App\7-Zip\7z.exe call :Download-7zip
.\bin\7-ZipPortable\App\7-Zip\7z.exe x .\extra\discord.exe * -o.\temp\
del .\temp\RELEASES
del .\temp\Update.exe
del .\extra\discord.exe
(goto) 2>nul

########################################################################

:Extract-Discord-Nupkg
cls
title Portable Discord Launcher - Experimental Edition - Extract Discord Nupkg
for %%d in (.\temp\Discord*.nupkg) do set discord=%%d
if not exist .\bin\7-ZipPortable\App\7-Zip\7z.exe call :Download-7zip
...
:Update-Wget
cls
title Portable Discord Launcher - Experimental Edition - Update Wget
...
:Latest-Build
cls
title Portable Discord Launcher - Experimental Edition - Latest Build :D
...
:New-Update
cls
title Portable Discord Launcher - Experimental Edition - Old Build D:
echo %NAG%
set nag="Selection Time!"
...
:Update-Now
cls & if not exist .\bin\wget.exe call :Download-Wget
cls & title Portable Discord Launcher - Experimental Edition - Updating Launcher
cls & .\bin\wget.exe -q --show-progress https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/raw/master/launch_discord.bat
cls & if exist launch_discord.bat.1 goto Replacer-Create
...
echo del launch_discord.bat >> replacer.bat
echo rename launch_discord.bat.1 launch_discord.bat >> replacer.bat
echo start launch_discord.bat >> replacer.bat
...
:cmd
cls
title Portable Discord Launcher - Experimental Edition - Command Prompt - By MarioMasta64
ver
