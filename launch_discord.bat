...
echo set "folder=%%CD%%" >> quicklaunch_discord.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_discord.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_discord.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_discord.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_discord.bat
echo cls >> quicklaunch_discord.bat
echo start .\bin\discord\discord.exe >> quicklaunch_discord.bat
echo exit >> quicklaunch_discord.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_discord.bat
