...
Color 0A
cls
title Portable TeamViewer Launcher - Helper Edition
...
:2
:LaunchTeamViewer
if not exist ".\bin\teamviewer\TeamViewer.exe" set "nag=PLEASE INSTALL TEAMVIEWER FIRST" && (goto) 2>nul
title DO NOT CLOSE
cls
...
:3
:ResetTeamViewer
rmdir /s /q .\bin\teamviewer\TeamViewer\
(goto) 2>nul

:4
:UninstallTeamViewer
echo y | del .\bin\teamviewer\*.*
(goto) 2>nul
...
echo set "folder=%%CD%%" >> quicklaunch_teamviewer.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_teamviewer.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_teamviewer.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_teamviewer.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_teamviewer.bat
echo cls >> quicklaunch_teamviewer.bat
echo cd .\bin\teamviewer\ >> quicklaunch_teamviewer.bat
echo start TeamViewer.exe >> quicklaunch_teamviewer.bat
...
:Credits
cls
if exist .\doc\teamviewer_license.txt (goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_teamviewer.bat" "launch_teamviewer.bat.1"
cls & if exist launch_teamviewer.bat.1 goto ReplacerCreate
