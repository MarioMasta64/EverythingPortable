...
Color 0A
cls
title Portable Dolphin Launcher - Helper Edition
...
:2
:LaunchDolphin
if not exist ".\bin\dolphin\dolphin.exe" set "nag=PLEASE INSTALL DOLPHIN FIRST" && (goto) 2>nul
title DO NOT CLOSE
cls
...
rmdir /s /q .\data\dolphin\
(goto) 2>nul

:4
:UninstallDolphin
taskkill /f /im dolphin.exe
rmdir /s /q .\bin\dolphin\
del .\extra\dolphin-x64-5.0.exe
(goto) 2>nul
...
:About
cls
del .\doc\dolphin_license.txt
start launch_dolphin.bat
exit
...
echo @echo off > quicklaunch_dolphin.bat
echo Color 0A >> quicklaunch_dolphin.bat
echo cls >> quicklaunch_dolphin.bat
echo set "folder=%%CD%%" >> quicklaunch_dolphin.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_dolphin.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_dolphin.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_dolphin.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_dolphin.bat
echo cls >> quicklaunch_dolphin.bat
echo set "Path=%%path%%;%%folder%%\dll\64\;" >> quicklaunch_dolphin.bat
echo start .\bin\dolphin\dolphin.exe -u "%%folder%%\data\dolphin" >> quicklaunch_dolphin.bat
echo exit >> quicklaunch_dolphin.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_dolphin.bat
...
:Credits
cls
if exist .\doc\dolphin_license.txt (goto) 2>nul
echo ================================================== > .\doc\dolphin_license.txt
echo =              Script by MarioMasta64            = >> .\doc\dolphin_license.txt
echo =           Script Version: v%current_version%- release        = >> .\doc\dolphin_license.txt
echo ================================================== >> .\doc\dolphin_license.txt
echo =You may Modify this WITH consent of the original= >> .\doc\dolphin_license.txt
echo = creator, as long as you include a copy of this = >> .\doc\dolphin_license.txt
echo =      as you include a copy of the License      = >> .\doc\dolphin_license.txt
echo ================================================== >> .\doc\dolphin_license.txt
echo =    You may also modify this script without     = >> .\doc\dolphin_license.txt
echo =         consent for PERSONAL USE ONLY          = >> .\doc\dolphin_license.txt
echo ================================================== >> .\doc\dolphin_license.txt
cls
title Portable Dolphin Launcher - Helper Edition - About
for /f "DELIMS=" %%i in (.\doc\dolphin_license.txt) do (echo %%i)
pause
call :PingInstall
(goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_dolphin.bat" "launch_dolphin.bat.1"
cls & if exist launch_dolphin.bat.1 goto ReplacerCreate
...
echo del launch_dolphin.bat >> replacer.bat
echo rename launch_dolphin.bat.1 launch_dolphin.bat >> replacer.bat
echo start launch_dolphin.bat >> replacer.bat
