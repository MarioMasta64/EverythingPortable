...
echo !retroarch_link!
echo !counter!
if "!retroarch_link:~0,37!"=="https://buildbot.libretro.com/stable/" echo hit & goto ExitUpgradeSearchLoop
...
if exist .\data\retroarch\ call :Release-v21-Upgrade
...
:Release-v21-Upgrade
if exist .\bin\retroarch\config\retroarch-studio\ rmdir /s /q .\bin\retroarch\config\retroarch-studio\
xcopy .\data\retroarch\* .\bin\retroarch\config\retroarch-studio\ /e /i /y
if exist .\data\retroarch\ rmdir /s /q .\data\retroarch\
exit /b 2
