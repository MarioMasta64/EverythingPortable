...
.\bin\wget.exe "https://discordapp.com/api/download/canary?platform=win" 
move 7-ZipPortable_16.04.paf.exe .\extra\7-ZipPortable_16.04.paf.exe
rename "canary@platform=win" discord_canary.exe
...
.\bin\7-ZipPortable\App\7-Zip%arch%\7z.exe x .\extra\discord_canary.exe * -o.\temp\
del .\temp\RELEASES
del .\temp\Update.exe
