...
Color 0A
cls
title Portable TeamViewer Host Launcher - Helper Edition
...
if not exist ".\bin\teamviewer_host\TeamViewer.exe" set "nag=PLEASE INSTALL TEAMVIEWER HOST FIRST" && (goto) 2>nul
title DO NOT CLOSE
cls
...
echo set "folder=%%CD%%" >> quicklaunch_teamviewer_host.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_teamviewer_host.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_teamviewer_host.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_teamviewer_host.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_teamviewer_host.bat
echo cls >> quicklaunch_teamviewer_host.bat
echo cd .\bin\teamviewer_host\ >> quicklaunch_teamviewer_host.bat
eho start TeamViewer.exe >> quicklaunch_teamviewer_host.bat
...
:Credits
cls
if exist .\doc\teamviewer_host_license.txt (goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_teamviewer_host.bat" "launch_teamviewer_host.bat.1"
cls & if exist launch_teamviewer_host.bat.1 goto ReplacerCreate
