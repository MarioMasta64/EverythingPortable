...
:3
:ResetWinSCP
del .\AppData\Roaming\winscp.rnd
(goto) 2>nul

:4
:UninstallWinSCP
rmdir /s /q .\bin\WinSCP\
(goto) 2>nul
...
:About
cls
del .\doc\winscp_license.txt
start launch_winscp.bat
exit
...
echo @echo off > quicklaunch_winscp.bat
echo Color 0A >> quicklaunch_winscp.bat
echo cls >> quicklaunch_winscp.bat
echo set "folder=%%CD%%" >> quicklaunch_winscp.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_winscp.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_winscp.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_winscp.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_winscp.bat
echo cls >> quicklaunch_winscp.bat
echo cd .\bin\WinSCP\ >> quicklaunch_winscp.bat
echo start WinSCP.exe >> quicklaunch_winscp.bat
echo exit >> quicklaunch_winscp.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_winscp.bat
...
:Credits
cls
if exist .\doc\winscp_license.txt (goto) 2>nul
echo ================================================== > .\doc\winscp_license.txt
echo =              Script by MarioMasta64            = >> .\doc\winscp_license.txt
echo =           Script Version: v%current_version%- release        = >> .\doc\winscp_license.txt
echo ================================================== >> .\doc\winscp_license.txt
echo =You may Modify this WITH consent of the original= >> .\doc\winscp_license.txt
echo = creator, as long as you include a copy of this = >> .\doc\winscp_license.txt
echo =      as you include a copy of the License      = >> .\doc\winscp_license.txt
echo ================================================== >> .\doc\winscp_license.txt
echo =    You may also modify this script without     = >> .\doc\winscp_license.txt
echo =         consent for PERSONAL USE ONLY          = >> .\doc\winscp_license.txt
echo ================================================== >> .\doc\winscp_license.txt
cls
title Portable WinSCP Launcher - Helper Edition - About
for /f "DELIMS=" %%i in (.\doc\winscp_license.txt) do (echo %%i)
pause
call :PingInstall
(goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_winscp.bat" "launch_winscp.bat.1"
cls & if exist launch_winscp.bat.1 goto ReplacerCreate
...
echo del launch_winscp.bat >> replacer.bat
echo rename launch_winscp.bat.1 launch_winscp.bat >> replacer.bat
echo start launch_winscp.bat >> replacer.bat
