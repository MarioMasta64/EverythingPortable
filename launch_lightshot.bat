...
Color 0A
cls
title Portable Lightshot Launcher - Helper Edition
...
rmdir /s /q .\data\Documents\Lightshot
(goto) 2>nul
...
:About
cls
del .\doc\lightshot_license.txt
start launch_lightshot.bat
exit
...
echo @echo off > quicklaunch_lightshot.bat
echo Color 0A >> quicklaunch_lightshot.bat
echo cls >> quicklaunch_lightshot.bat
echo set "folder=%%CD%%" >> quicklaunch_lightshot.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_lightshot.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_lightshot.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_lightshot.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_lightshot.bat
echo cls >> quicklaunch_lightshot.bat
echo start .\bin\lightshot\lightshot.exe >> quicklaunch_lightshot.bat
echo exit >> quicklaunch_lightshot.bat
echo A QUICKLAUNCHER HAS BEEN WRITTEN TO: quicklaunch_lightshot.bat
...
if exist setup-lightshot.exe del setup-lightshot.exe
...
:Credits
cls
if exist .\doc\lightshot_license.txt (goto) 2>nul
echo ================================================== > .\doc\lightshot_license.txt
echo =              Script by MarioMasta64            = >> .\doc\lightshot_license.txt
echo =           Script Version: v%current_version%- release        = >> .\doc\lightshot_license.txt
echo ================================================== >> .\doc\lightshot_license.txt
echo =You may Modify this WITH consent of the original= >> .\doc\lightshot_license.txt
echo = creator, as long as you include a copy of this = >> .\doc\lightshot_license.txt
echo =      as you include a copy of the License      = >> .\doc\lightshot_license.txt
echo ================================================== >> .\doc\lightshot_license.txt
echo =    You may also modify this script without     = >> .\doc\lightshot_license.txt
echo =         consent for PERSONAL USE ONLY          = >> .\doc\lightshot_license.txt
echo ================================================== >> .\doc\lightshot_license.txt
cls
title Portable Lightshot Launcher - Helper Edition - About
for /f "DELIMS=" %%i in (.\doc\lightshot_license.txt) do (echo %%i)
pause
call :PingInstall
(goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_lightshot.bat" "launch_lightshot.bat.1"
cls & if exist launch_lightshot.bat.1 goto ReplacerCreate
...
echo del launch_lightshot.bat >> replacer.bat
echo rename launch_lightshot.bat.1 launch_lightshot.bat >> replacer.bat
echo start launch_lightshot.bat >> replacer.bat
