...
echo !krita_link!
echo !counter!
if "!krita_link:~5,38!"=="https://download.kde.org/stable/krita/" echo hit & goto ExitUpgradeSearchLoop
...
if exist .\data\krita\ call :Release-v21-Upgrade
...
:Release-v21-Upgrade
if exist .\bin\krita\config\krita-studio\ rmdir /s /q .\bin\krita\config\krita-studio\
xcopy .\data\krita\* .\bin\krita\config\krita-studio\ /e /i /y
if exist .\data\krita\ rmdir /s /q .\data\krita\
exit /b 2
