...
Color 0A
cls
title Portable LastPass Launcher - Helper Edition
...
:2
:LaunchLastPass
if not exist ".\bin\lastpass\lastapp.exe" set "nag=PLEASE INSTALL LASTPASS FIRST" && (goto) 2>nul
title DO NOT CLOSE
cls
...
rmdir /s /q .\data\AppData\Local\Lastpass\
rmdir /s /q .\data\AppData\Roaming\Lastpass\
(goto) 2>nul

:4
:UninstallLastPass
taskkill /f /im lastapp.exe
rmdir /s /q .\bin\lastpass\
del .\extra\lastpassappinstall.exe
(goto) 2>nul
...
echo set "folder=%%CD%%" >> quicklaunch_lastpass.bat
echo if "%%CD%%"=="%%~d0\" set "folder=%%CD:~0,2%%" >> quicklaunch_lastpass.bat
echo set "UserProfile=%%folder%%\data\" >> quicklaunch_lastpass.bat
echo set "AppData=%%folder%%\data\AppData\Roaming\" >> quicklaunch_lastpass.bat
echo set "LocalAppData=%%folder%%\data\AppData\Local\" >> quicklaunch_lastpass.bat
echo cls >> quicklaunch_lastpass.bat
echo start .\bin\lastpass\lastapp.exe >> quicklaunch_lastpass.bat
...
if exist lastappinstall.exe del lastappinstall.exe
...
rmdir /s /q .\bin\lastpass\$PLUGINSDIR\
del .\bin\lastpass\lastappuninstall.exe.nsis
(goto) 2>nul
...
:Credits
cls
if exist .\doc\lastpass_license.txt (goto) 2>nul
...
call :HelperDownload "https://raw.githubusercontent.com/MarioMasta64/EverythingPortable/master/launch_lastpass.bat" "launch_lastpass.bat.1"
cls & if exist launch_lastpass.bat.1 goto ReplacerCreate
