...
if exist .\data\AppData\Local\Lastpass\ rmdir /s /q .\data\AppData\Local\Lastpass\
if exist .\data\AppData\Roaming\Lastpass\ rmdir /s /q .\data\AppData\Roaming\Lastpass\
(goto) 2>nul
